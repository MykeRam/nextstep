    ...
    <main className="app-shell">
      ...
      <section className="card follow-ups-card" aria-labelledby="follow-ups-title">
        <div className="section-heading">
          ...
          <span className="follow-up-count">{upcomingFollowUps.length} scheduled</span>
        </div>
        ...
        <div className="toolbar">
          ...
          <div className="filters">
            ...
            <select
              ...
              value={sortBy}
              onChange={(event) =>
                setSortBy(event.target.value as 'followUp' | 'appliedDate' | 'company')
              }
            >
        ...
        {visibleApplications.length === 0 ? (
            ...
            {visibleApplications.map((application) => (
              <li key={application.id}>
                ...
                <select
                  ...
                  onChange={(event) =>
                    updateApplicationStatus(application.id, event.target.value as Status)
                  }
                >
                  {STATUSES.map((status) => (
                    <option key={status}>{status}</option>
          ...
          <div className="board-view">
            {boardStatuses.map((status) => {
              const applicationsInStage = visibleApplications.filter(
